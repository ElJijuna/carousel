...
test.describe("split cards", () => {
	...
	test("stays split, and inside the card, on a narrower slide", async ({
		page,
	}) => {
...
test.describe("credit cards", () => {
	test("loops in the data mode, not just the children one", async ({
		page,
	}) => {
...
test.describe("page layout", () => {
	test("the footer holds the dots and the primary action at once", async ({
		page,
	}) => {
